setwd("/Users/hasansulaeman/Dropbox/Africa Bd Project/Africa manuscript/data")
data=read.csv("GLMdata.csv", header=TRUE)
...
data$long = measurements::conv_unit(data$Longitude, from = 'deg_dec_min', to = 'dec_deg')
data = data[1:8657,]
